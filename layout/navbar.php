...
<div id="offcanvasMenu" class="offcanvas">
    ...
    <div class="border-t border-gray-200 px-6 py-4">
        <a href="#" onclick="if(confirm('Apakah Anda yakin ingin keluar?')) { window.location.href='logout.php'; } return false;" class="flex items-center px-4 py-3 text-red-600 hover:bg-red-50 rounded-lg transition">
